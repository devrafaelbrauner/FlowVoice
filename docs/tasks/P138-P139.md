...
- **Prévia sobre campo com teclado** (nota do próprio FlowVoice, inserção
  ...
  do cursor**. O toque na bolha e a prévia não geraram `input_generation`.
...
- **A prévia colada à bolha pode cobrir o cursor** quando a bolha está perto do
  texto, como no S26 acima. Isso depende de onde o usuário deixa a bolha.
  Alternativas: faixa compacta no topo da tela, cartão recolhível ou posicionar a
  prévia longe do cursor lido pela acessibilidade (custo e privacidade maiores).
